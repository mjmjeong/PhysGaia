    ...
    with ProcessPoolExecutor(max_workers=len(gpus)) as exc:
        for i, img_dir in enumerate(img_dirs):
            ...
            exc.submit(
                ...
                f"{base_dir}/{metric_depth_name}_temp", 
                f"{base_dir}/{intrins_name}_temp", 
                f"{base_dir}/{mono_depth_name}_temp", 
                f"{base_dir}/aligned_{mono_depth_name}_temp",  
                f"{base_dir}/{slam_name}_temp",  
                f"{base_dir}/{track_model}_temp",  
                mono_depth_model,
                track_model,
                tapir_torch,
                matching_pattern,
