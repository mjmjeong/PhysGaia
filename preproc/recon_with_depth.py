...
def get_calib_from_camera_json(data, img_dir, use_width_for_focal=False):
    ...
    for frame in data["frames"]:
        ...
        calib_dict[image_name] = [fx, fy, cx, cy]
...
def image_stream(img_dir, calib_path, stride, matching_pattern, depth_dir: str | None = None):
    ...
    if "camera_angle_x" in data:
        calib_dict = get_calib_from_camera_json(data, img_dir)
    else:
        calib_dict = data
...
if __name__ == "__main__":
    ...
    parser.add_argument("--matching_pattern", type=str, default="0_*", help="Filename pattern like '1_*'")
