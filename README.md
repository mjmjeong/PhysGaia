...
This branch contains the implementation of [STG (CVPR2024)](https://github.com/oppo-us-research/SpacetimeGaussians) using our PhysGaia dataset.
For general information about PhysGaia, please refer to the [main branch](https://github.com/mjmjeong/PhysGaia).

## **💻 Getting Started with STG on PhysGaia**

### Training

```
python train.py -source_path path/to/your/physgaia/dataset --model_path output/exp-name --num_views single --init_with_traj --configs configs/base_phystrack_full.json --eval
```

### Evaluation

```
python test.py --quiet --eval --skip_train --configpath configs/base_phystrack_full.json --model_path output/exp-name --source_path path/to/your/physgaia/dataset
```
