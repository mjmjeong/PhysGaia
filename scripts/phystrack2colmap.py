...
for frame in meta['frames']:
    ...
    idx+=1
    # breakpoint()
    print(os.path.join(image_dir,"render",frame['file_path']),os.path.join(imagecolmap_dir,frame['file_path'].split('/')[-1]+".png"))
    shutil.copy(os.path.join(image_dir,"render",frame['file_path']+".png"),os.path.join(imagecolmap_dir,frame['file_path'].split('/')[-1]+".png"))
